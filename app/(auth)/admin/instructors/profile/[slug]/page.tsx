...
interface SingleinstructorProfileProps {
  params: Promise<{ slug: string }>;
}

export default function SingleinstructorProfile({
  params,
}: SingleinstructorProfileProps) {
  ...
  return (
    <div className="flex flex-col gap-3 xl:flex-row p-3">
          ...
          <div className="h-[400px] overflow-hidden rounded-xl border lg:h-[200px]">
            ...
            <div className="relative flex h-full flex-col items-center justify-center gap-6 p-6 text-white lg:flex-row lg:items-end lg:justify-between">
              ...
              <div className="text-center lg:text-start">
                ...
                <span className="text-xs">{instructor.info}</span>
              </div>
              <div className="flex gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="text-sm">{instructor.reviews}</h2>
      ...
      <div className="xl:w-[350px]">
        ...
        <div className="border bg-white rounded-xl p-4 mb-4 shadow-sm">
          ...
          <ul>
            {instructor.reviews_content.map((review, index) => {
              return (
        ...
        <div className="border bg-white rounded-xl p-4 mb-4 shadow-sm">
          ...
          <ul>
            <li className="flex items-center gap-2 mb-4">
              <MapPin size={23} />
              <h4 className="text-sm font-semibold">{instructor.country}</h4>
            </li>
            <li className="flex items-center gap-2 mb-4">
              <Languages size={23} />
              <h4 className="text-sm font-semibold">
