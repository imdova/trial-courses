...
export default function SingleCourseOverview({
  ...
  const [activeTab, setActiveTab] = useState("coursesOverview");
      ...
      {activeTab === "coursesOverview" && (
        <div>
          ...
          <div className="flex flex-col gap-4 xl:flex-row mb-4">
            <div className="grid grid-cols-1 flex-1 p-4 rounded-lg border bg-white shadow-sm overflow-hidden">
