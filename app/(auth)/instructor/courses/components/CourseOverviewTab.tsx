  ...
  return (
    <div className="space-y-4">
      <Card>
        ...
        <CardFooter className="gap-2">
          <Avatar className="size-12">
            ...
            <AvatarFallback>
              {course.instructor?.fullName?.charAt(0).toUpperCase() || "U"}
            </AvatarFallback>
          </Avatar>
      ...
      <Card className="bg-primary/10 space-y-4">
        <CardHeader>
          <CardTitle> What You Will Learn In This Free Course</CardTitle>
          <CardDescription>
          ...
          <ul className="grid grid-cols-1 gap-3 md:grid-cols-2">
            {course.metadata.whatWillYouLearn.items?.map((learnItem, index) => (
              <li key={index}>
                ...
                <span className="text-sm">{learnItem}</span>
              </li>
            ))}
          </ul>
        </CardContent>
      ...
      <Card className="space-y-4 border-none !shadow-none">
        <CardHeader>
          ...
          <CardDescription>{course.metadata.whoCanAttend.text}</CardDescription>
        </CardHeader>
        <CardContent>
          <ul className="grid grid-cols-1 gap-3 md:grid-cols-2">
