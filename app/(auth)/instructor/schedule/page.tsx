      ...
      <div className="flex flex-col justify-between items-center gap-4 mb-6 md:flex-row">
        <div className="flex items-center space-x-2 mr-4">
          <button
            ...
            className={`px-4 py-2 rounded-full text-sm ${currentFilter === "all"
          ...
          <button
            ...
            className={`px-4 py-2 rounded-full text-sm ${currentFilter === "upcoming"
              ? "bg-green-600 text-white"
              : "bg-gray-100 text-gray-700"
              }`}
          >
          ...
          <button
            ...
            className={`px-4 py-2 rounded-full text-sm ${currentFilter === "pending"
              ? "bg-green-600 text-white"
              : "bg-gray-100 text-gray-700"
              }`}
          >
          ...
          <button
            ...
            className={`px-4 py-2 rounded-full text-sm ${currentFilter === "past"
              ? "bg-green-600 text-white"
              : "bg-gray-100 text-gray-700"
              }`}
          >
