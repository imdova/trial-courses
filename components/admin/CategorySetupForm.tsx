...
import { Upload, Loader2, Image as ImageIcon, Plus, X, Trash2 } from "lucide-react";
...
export default function CategorySetupForm({
  onSubmit,
  initialData,
}: CategorySetupFormProps) {
  ...
  return (
    <Card className="p-6">
      <div className="mb-6 flex items-center gap-2">
        ...
        <h3 className="text-lg font-semibold text-gray-900">Category Setup</h3>
      </div>
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              />
              <p className="mt-1 text-xs text-gray-500">
                Optional: Display order for the category (defaults to 0)
              </p>
            </div>
          ...
          {/* Right Column - Logo Upload, Headline, and Rich Description */}
          <div className="space-y-4">
            <div>
