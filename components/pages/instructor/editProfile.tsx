...
const initialValues = (
  user: InstructorData & { title?: string },
  ...
  country: user?.country ? {
    ...
    name: "" // Empty name since InstructorData only has code
  } : null,
  city: null,
});
...
const EditProfile: React.FC<EditProfileProps> = ({ user }) => {
  ...
  async function handleSuccess(newProfile: InstructorProfile) {
    await updateSession({
    ...
    <>
      <FormModal
        ...
        initialValues={initialValues({
          ...user,
          title: getExperienceDetail(user.firstName || ""),
        })}
      />
